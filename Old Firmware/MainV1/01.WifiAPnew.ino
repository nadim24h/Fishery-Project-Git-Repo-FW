...
//
//  //Device Is ON
//  String deviceState = "true";
//  (!DeviceIsON) ? deviceState = "false" : deviceState = "true";
//
//  //Relay 1 AND 2
//  String R1On = "true";
...
//
//  //  String QueryString = "http://api.automatedfishfarm.com/1.0/DC2/?Dc=" + DeviceCode + "&IsOn=" + IsOn + "&R1On=" + R1On + "&R2On=" + R2On + "&T1=" + T1 + "&T2=" + T2 +
//  //                       "&Hc=" + HasLocallyChanges + "&M=W&Cnt=" + RequestCount;
//
//
//
...
//
//  int httpResponseCode = http.PUT(jsonPayload);     //Send the request
