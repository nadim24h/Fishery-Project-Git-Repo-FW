...
void GSMAPIConnect()
{
    ...
    //const char resource[] = "/1.0/DC2/?Dc=A2001XBCW&IsOn=true&R1On=true&R2On=true&T1=30&T2=34";
     String resource = "/1.0/DC2/?Dc="+DeviceCode+"&IsOn="+IsOn+"&R1On="+R1On+"&R2On="+R2On+"&T1="+T1+"&T2="+T2+"&Hc="+HasChanges+"&M=G&Cnt="+RequestCount;
    //String resource = "/1.0/DeviceComm/?DeviceCode="+DeviceCode+"&IsOn="+IsOn+"&R1On="+R1On+"&R2On="+R2On+"&T1="+T1+"&T2="+T2+"&Hc="+HasChanges;
